      ...
      <div class="col-lg-4 mx-auto">
        <div class="auth-form-light text-start py-5 px-4 px-sm-5">
          ...
          <form class="user" method="post" action="<?= base_url('home/insertktna'); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="form-label">Tanggal Lahir (Format : Tahun - Bulan - Lahir)</label>
              <div class="row">
                <div class="col-lg-4">
                  <input type="number" class="form-control form-control-user" id="tahun_lahir" name="tahun_lahir" value="<?= set_value('tahun'); ?>" placeholder="1997" min="1900" max="3000">
                </div>

                <div class="col-lg-4">
                  <input type="number" class="form-control form-control-user" id="bulan_lahir" name="bulan_lahir" value="<?= set_value('bulan'); ?>" placeholder="08" min="1" max="12">
                </div>

                <div class="col-lg-4">
                  <input type="number" class="form-control form-control-user" id="tanggal_lahir" name="tanggal_lahir" value="<?= set_value('tanggal'); ?>" placeholder="07" min="1" max="31">
                </div>
              </div>
