...
<div class="content-wrapper">
  ...
  <div class="card">
    <div class="card-body">
      <form action="<?= base_url('staff/save_apl02/' . $this->uri->segment(3)) ?>" method="POST" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <hr>
          <h4>Pemohon <?= $data_asesi->full_name ?></h4>
          <h4>Tanda Tangan</h4>
          <div>
            <img src="<?= base_url('uploads/tanda_tangan/' . $ttd_asesi) ?>" alt="">
          </div>
          <br>
          <hr>
          <h5>Rekomendasi</h5>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="correct" id="correct" value="Asesmen Dapat Di Lanjutkan" checked>
            <label class="form-check-label" for="flexRadioDefault1">
              Asesmen Dapat Di Lanjutkan
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="correct" id="correct" value="Asesmen Tidak Dapat Di Lanjutkan">
