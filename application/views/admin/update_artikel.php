  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="<?= base_url('admin/process_update_artikel') ?>" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id_edit" value="<?= $data_artikel->Id ?>">
          <div class="form-group row">
            <label for="username" class="col-sm-3 col-form-label">Thumbnail</label>
            <div class="col-sm-9">
              <input type="file" class="form-control form-control-sm" name="thumbnail" id="thumbnail" value="<?php echo set_value('thumbnail'); ?>" placeholder="Thumbnail">
            </div>
          </div>
          <div class="form-group row">
            <label for="email" class="col-sm-3 col-form-label">Title</label>
            <div class="col-sm-9">
              <input type="title" class="form-control form-control-sm" name="title" id="title" value="<?= $data_artikel->title ?>" placeholder="Title" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="mobile_number" class="col-sm-3 col-form-label">Text</label>
            <div class="col-sm-9">
              <textarea class="form-control form-control-sm" id="summernote" name="text"><?= $data_artikel->text ?></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label for="address" class="col-sm-3 col-form-label">Tanggal</label>
            <div class="col-sm-9">
              <input type="datetime-local" class="form-control form-control-sm" name="tanggal" id="tanggal" value="<?= $data_artikel->tanggal ?>" placeholder="Tanggal" required>
            </div>
          </div>
